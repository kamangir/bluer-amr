...
|   |
| --- |
| [`meta-analysis`](./doc/meta-analysis.md) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](./doc/meta-analysis.md) meta analysis of anti-biotics for cholera. |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 🔬 [`bluer_amr-6.5.1`](https://github.com/kamangir/bluer-amr).
